...
규모 가중이 유사도를 **살 수 없게** 만드는 것이 핵심이다. 무관한 대형주는 ①에서 걸린다.
...
**정직하게 남기는 것**
    ...
    · 남는 한계 (실측에서 실제로 나온 것):
      ...
      사업보고서 문장이 비슷하면 역할이 달라도 가까이 놓인다. **top1 이 75% 다.**
...
def search(query: str, limit: int = 10) -> Dict:
    ...
    return {
        ...
        "note": ("사업보고서 본문으로 찾는다. 실측 top1 75% · top3 85% · top5 95% "
                 "(자연어 질의 20건). **1위가 늘 맞지는 않는다** — 사업 설명이 비슷하면 "
                 "역할이 달라도 가까이 놓인다 (예: '자동차 완성차' 에 부품사가 올라온다)."),
    }
